...
/**
 * Base class for all  the API controllers for manipulating DomainObjects. Add
 * in any fields or functionality that ought to be shared throughout.
 * PLEASE NOTE: For (almost) all  the REST API endpoints that deal with the
...
public abstract class APIController {
     ...
     * the REST API. Contains a status of the action and a message.
     *
